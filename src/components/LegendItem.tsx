...
const LegendItem: FC<LegendItemType> = ({ color, diapasonStart, lastValue }) => {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      {lastValue !== null && (
        <div className="absolute left-1/2 top-1/2 flex h-5 w-16 -translate-x-1/2 translate-y-2 items-center justify-center border border-black bg-white text-center text-xs">
